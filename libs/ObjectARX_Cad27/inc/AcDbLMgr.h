...
class AcDbLayoutManager: public AcRxObject  {
  public:
    ...
    // This overload is deprecated and will be removed. Please use getActiveLayoutName()
            const ACHAR * findActiveLayout(bool allowModel,
                                        const AcDbDatabase* pDb = nullptr);       // deprecated
...
// Returned string pointer is only valid until next call to this method
//
