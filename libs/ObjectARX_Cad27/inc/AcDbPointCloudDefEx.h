...
public:
    ...
    enum Property
    {
        ...
        /// <summary> The Classification property for terrestrial scans. </summary>
        kTerrestrialClassification = 7,
    };
    ...
    /// <summary>
    /// Gets the classification ramp defined inside the point cloud project
