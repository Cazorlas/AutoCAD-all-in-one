...
public:
    ...
    /// </param>
    Acad::ErrorStatus getCandidatePlane(const POINT& pt, AcGePlane &result, double &distToEdge, double &objWidth, double &objHeight, void*& context) const;
    ...
    /// <summary> If set as true
    /// The traverse* and getPointData* Apis will include 
    /// classification data for terrestrial scans.
