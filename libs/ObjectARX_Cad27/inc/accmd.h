...
public:
    ...
    ACCORE_PORT void addReactor(AcEdCommandReactor* pReactor);
    ACCORE_PORT void removeReactor(AcEdCommandReactor* pReactor);
...
{
public:
    ACRX_DECLARE_MEMBERS_EXPIMP(AcEdCommandReactor, ACCORE_PORT);
...
{
public:
    ACRX_DECLARE_MEMBERS_EXPIMP(AcEdCommandStackReactor , ACCORE_PORT);
...
public:
    ...
    ACCORE_PORT void addReactor(AcEdCommandStackReactor* pReactor);
    ACCORE_PORT void removeReactor(AcEdCommandStackReactor* pReactor);
};
