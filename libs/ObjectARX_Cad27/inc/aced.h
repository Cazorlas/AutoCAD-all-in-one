 ...
 */
ACCORE_PORT void acedUpdateDisplay();
...
ACCORE_PORT Acad::ErrorStatus acedSetCurrentVPort(int vpnumber);
...
ACAD_PORT Acad::ErrorStatus acedGetCurrentUCS(AcGeMatrix3d& mat);
...
ACAD_PORT Acad::ErrorStatus acedGetCurrentSelectionSet(AcDbObjectIdArray& sset);
...
/// <summary>
/// Waits until all backround raster image loading results are processed
/// and the canvas is updated.
/// </summary>
ACCORE_PORT void acedRasterImageAsyncTaskWait();
