...
ACCORE_PORT void                acgsSetHighlightProperties ( int                colorIndex,
                                                             AcGs::LinePattern  pattern,
                                                             int                weight,
...
ACCORE_PORT Adesk::Boolean  acgsSetViewParameters         (int viewportNumber, const AcGsView * pView,
                                               bool bRegenRequired, bool bRescaleRequired,
                                               bool bSyncRequired = false);
ACCORE_PORT Adesk::Boolean  acgsGetViewParameters         (int viewportNumber, AcGsView * pView);
