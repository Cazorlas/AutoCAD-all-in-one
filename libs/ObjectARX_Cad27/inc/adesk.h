...
struct Adesk
{
    ...
    // See also std::numeric_limits<double>.max(), .min() and .lowest()
    // or DBL_MAX and DBL_MIN in C's float.h
    //
    static constexpr double kMaxDouble = 1.7976931348623157e+308;
    static constexpr double kMinDouble = 2.2250738585072014e-308;
...
#if INTPTR_MAX == INT32_MAX //32 bit build
...
#elif INTPTR_MAX == INT64_MAX //64 bit build
