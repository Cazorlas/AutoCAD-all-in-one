...
#ifdef _AFXEXT
	#pragma comment (lib ,"acui26.lib")
	#pragma comment (lib ,"adui26.lib")
...
#pragma comment (lib ,"AcFdEval.lib")
	...
	#pragma comment (lib ,"aseapi26.lib")
	#pragma comment (lib ,"asiapi26.lib")
#else
	#pragma comment (lib ,"aseapi26d.lib")
	#pragma comment (lib ,"asiapi26d.lib")
#endif
