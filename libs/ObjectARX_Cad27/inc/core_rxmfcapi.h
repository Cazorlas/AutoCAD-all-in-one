...
/* acedCommandActive()
 * Returns the value of the CMDACTIVE sysvar
 */
ACCORE_PORT DWORD acedCommandActive();

/* acedIsScriptActive()
 * Returns true if script is active
 */
ACCORE_PORT bool acedIsScriptActive();

/* acedIsLispActive()
 * Returns true if AutoLISP is active
 */
ACCORE_PORT bool acedIsLispActive();

/* acedIsLispOrScriptActive()
 * Returns true if either script or AutoLISP is active
 */
