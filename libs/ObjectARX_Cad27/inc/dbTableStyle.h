...
#define AcDbTblStyl_Deprecated_ACHAR_Methods
    ...
    ADESK_DEPRECATED virtual double horzCellMargin(void) const final;
    // Use setMargin(AcDb::CellMargin nMargins, double fMargin, const ACHAR* pszCellStyle)
    ADESK_DEPRECATED virtual Acad::ErrorStatus setHorzCellMargin(double dCellMargin) final;

    // Use margin(AcDb::CellMargin nMargin, const ACHAR* pszCellStyle)
    ADESK_DEPRECATED virtual double vertCellMargin(void) const final;
    // Use setMargin(AcDb::CellMargin nMargins, double fMargin, const ACHAR* pszCellStyle)
    ADESK_DEPRECATED virtual Acad::ErrorStatus setVertCellMargin(double dCellMargin) final;

    ADESK_DEPRECATED virtual bool isTitleSuppressed(void) const final;
    ADESK_DEPRECATED virtual Acad::ErrorStatus suppressTitleRow(bool bValue) final;

    ADESK_DEPRECATED virtual bool isHeaderSuppressed(void) const final;
    ADESK_DEPRECATED virtual Acad::ErrorStatus suppressHeaderRow(bool bValue) final;
    ...
    ADESK_DEPRECATED virtual bool isBackgroundColorNone(AcDb::RowType rowType = AcDb::kDataRow)
                                                                const final;
    ...
    ADESK_DEPRECATED virtual Acad::ErrorStatus   getDataType(AcValue::DataType& nDataType,
                                            ...
                                            AcDb::RowType rowType) const final;
    ...
    ADESK_DEPRECATED virtual const ACHAR* format (void) const final;
    // For internal use only
    ADESK_DEPRECATED virtual const ACHAR* format (AcDb::RowType rowType) const final;
