...
public:
    ...
    /// <summary>
    /// Create an AcDbDate object based on input std::tm.  Equivalent to using setTime
    /// </summary>
    /// <param name="time">Input time</param>
    /// <returns>AcDbDate object</returns>
    ACDBCORE2D_PORT static AcDbDate fromTime(const std::tm& time);
