...
public:
    ...
    ACCORE_PORT DragStatus acquireAngle(double &ang);
    ACCORE_PORT DragStatus acquireAngle(double &ang, const AcGePoint3d& basePnt);
    ...
    ACCORE_PORT AcEdJig::UserInputControls userInputControls();
