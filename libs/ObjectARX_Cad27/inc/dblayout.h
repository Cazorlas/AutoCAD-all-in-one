...
#define AcDbLayout_Deprecated_ACHAR_Methods
    ...
    /// <summary>
    /// This method can be called to test whether or not a valid thumbnail image exists for the layout.
    /// </summary>
    /// <returns> This will return Acad::eOk if a valid thumbnail exists. It returns error status otherwise </returns>
    ///
    ACDBCORE2D_PORT Acad::ErrorStatus 
    hasThumbnail(void) const;
