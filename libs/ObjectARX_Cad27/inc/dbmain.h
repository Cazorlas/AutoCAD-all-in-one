...
public:
    ...
    ACDBCORE2D_PORT
    virtual Acad::ErrorStatus   setColor(const AcCmColor& color, bool doSubents = true,
                                         AcDbDatabase *pDb = nullptr);
    Adesk::UInt16               colorIndex() const;
    ACDBCORE2D_PORT
    virtual Acad::ErrorStatus   setColorIndex(Adesk::UInt16 color, bool doSubents = true);
...
{
public:
    AcDbExtents2d() = default;
    AcDbExtents2d(const AcDbExtents2d& src) = default;
...
private:
    AcGePoint2d mMinPoint { AcDb::kDefaultExtentsCoordinate,  AcDb::kDefaultExtentsCoordinate};
    AcGePoint2d mMaxPoint {-AcDb::kDefaultExtentsCoordinate, -AcDb::kDefaultExtentsCoordinate};
};

inline bool AcDbExtents2d::isValid() const
{
    return mMinPoint.x <= mMaxPoint.x && mMinPoint.y <= mMaxPoint.y;
}

inline void AcDbExtents2d::reset()
{
    mMinPoint.set( AcDb::kDefaultExtentsCoordinate,  AcDb::kDefaultExtentsCoordinate);
    mMaxPoint.set(-AcDb::kDefaultExtentsCoordinate, -AcDb::kDefaultExtentsCoordinate);
}
...
public:
    AcDbExtents() = default;
    AcDbExtents(const AcDbExtents& src) = default;
...
private:
    AcGePoint3d mMinPoint { AcDb::kDefaultExtentsCoordinate,  AcDb::kDefaultExtentsCoordinate,
                            AcDb::kDefaultExtentsCoordinate};
    AcGePoint3d mMaxPoint {-AcDb::kDefaultExtentsCoordinate, -AcDb::kDefaultExtentsCoordinate,
                           -AcDb::kDefaultExtentsCoordinate};
};

inline bool AcDbExtents::isValid() const
{
    return mMinPoint.x <= mMaxPoint.x && mMinPoint.y <= mMaxPoint.y && mMinPoint.z <= mMaxPoint.z;
}

inline void AcDbExtents::reset()
{
    mMinPoint.set( AcDb::kDefaultExtentsCoordinate,  AcDb::kDefaultExtentsCoordinate,
                   AcDb::kDefaultExtentsCoordinate);
    mMaxPoint.set(-AcDb::kDefaultExtentsCoordinate, -AcDb::kDefaultExtentsCoordinate,
