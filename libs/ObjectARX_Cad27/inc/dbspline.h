...
public:
    ...
    /// Deprecated.  Please use the below overload instead.  Apps can query the PLINETYPE
    /// sysvar directly (when present) and set the bConvertAsArcs arg as desired.
    /// </summary>
    ...
    ACDBCORE2D_PORT Acad::ErrorStatus toPolyline(AcDbCurve*& pCurve, int precision = 10,
