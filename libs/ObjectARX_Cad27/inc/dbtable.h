...
public:
    ...
    ADESK_DEPRECATED virtual Acad::ErrorStatus setNumRows(int nRows) final;

    virtual Adesk::UInt32       numColumns() const;
    // Use setSize(int nRows, int nCols)
    ADESK_DEPRECATED virtual Acad::ErrorStatus setNumColumns(int nCols) final;
    ...
    ADESK_DEPRECATED virtual double horzCellMargin() const final;
    // Use setMargin(int nRow, int nCol, AcDb::CellMargin nMargin, double fMargin)
    ADESK_DEPRECATED virtual Acad::ErrorStatus setHorzCellMargin(double gap) final;

    // Use margin(int nRow, int nCol, AcDb::CellMargin nMargin)
    ADESK_DEPRECATED virtual double vertCellMargin() const final;
    // Use setMargin(int nRow, int nCol, AcDb::CellMargin nMargin, double fMargin)
    ADESK_DEPRECATED virtual Acad::ErrorStatus setVertCellMargin(double gap) final;

    virtual AcDb::FlowDirection flowDirection() const; 
    virtual Acad::ErrorStatus   setFlowDirection(AcDb::FlowDirection flow);

    ADESK_DEPRECATED virtual bool isTitleSuppressed() const final;
    ADESK_DEPRECATED virtual Acad::ErrorStatus suppressTitleRow(bool value) final;

    ADESK_DEPRECATED virtual bool isHeaderSuppressed() const final;
    ADESK_DEPRECATED virtual Acad::ErrorStatus suppressHeaderRow(bool value) final;

    ADESK_DEPRECATED virtual AcDb::CellAlignment alignment(AcDb::RowType type =
                                          AcDb::kDataRow) const final;
    ADESK_DEPRECATED virtual Acad::ErrorStatus   setAlignment(AcDb::CellAlignment align,
                                          int rowTypes = AcDb::kAllRows) final;
    ...
    ADESK_DEPRECATED virtual const ACHAR* format(AcDb::RowType type) final;
    // For internal use only
    ADESK_DEPRECATED virtual Acad::ErrorStatus setFormat(const ACHAR* pszFormat) final;
    // For internal use only
    ...
    ADESK_DEPRECATED virtual AcDb::LineWeight gridLineWeight(AcDb::GridLineType gridlineType,
                                AcDb::RowType type = AcDb::kDataRow) const final;
    ...
    ADESK_DEPRECATED virtual bool tableStyleOverrides(
                                               AcDbIntArray& overrides) const final;
    ADESK_DEPRECATED virtual void clearTableStyleOverrides(int options = 0) final;
    ...
    ADESK_DEPRECATED virtual Acad::ErrorStatus deleteCellContent(int row, int col) final;
    ADESK_DEPRECATED virtual AcDb::RowType rowType(int row) const final;
    ...
    ADESK_DEPRECATED virtual AcDb::RotationAngle textRotation(int row, int col) const final;
    // Use setRotation(int nRow, int nCol, int nContent, double fContent)
    ADESK_DEPRECATED virtual Acad::ErrorStatus  setTextRotation(int row, int col,
                                              AcDb::RotationAngle rot) final;
    ...
    ADESK_DEPRECATED virtual bool isAutoScale(int row, int col) const final;
    // Use setAutoScale(int row, int col, int nContent, autoFit)
    ADESK_DEPRECATED virtual Acad::ErrorStatus setAutoScale(int row, int col,
                                              bool autoFit) final;
    ...
    ADESK_DEPRECATED virtual double blockScale(int row, int col) const final;
    // Use setScale(int row, int col, int nContent, double scale)
    ADESK_DEPRECATED virtual Acad::ErrorStatus setBlockScale(int row, int col,
                                              double scale) final;

    // Use rotation(int nRow, int nCol, int nContent)
    ADESK_DEPRECATED virtual double blockRotation(int row, int col) const final;
    // Use setRotation(int nRow, int nCol, int nContent, double fContent)
    ADESK_DEPRECATED virtual Acad::ErrorStatus setBlockRotation(int row, int col,
                                              double rotAng) final;
