...
public:
    ...
    /// <summary>
    /// Indicates if the underlay should be loaded
    /// </summary>
    /// <returns>Returns false if the underlay has been explicitly unloaded, otherwise true
    /// </returns>
    ACDBCORE2D_PORT bool shouldLoad() const;
