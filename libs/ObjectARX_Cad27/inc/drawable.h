...
public:
    ...
    enum SetAttributesFlags
    {
        ...
        // When this flag is set, the drawable uses viewportDraw
        // to draw only two representations. On representation is
        // used in plan views and the other is used in isometric
        // views.
        kDrawablePlanOrIsometricViewportDraw    = 1048576
    };
