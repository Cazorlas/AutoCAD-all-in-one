...
public:
    ...
    GE_DLLEXPIMPORT AcGeKnotVector(AcGeKnotVector&& src);
    GE_DLLEXPIMPORT AcGeKnotVector(const AcGeDoubleArray& src, double eps = globalKnotTolerance);
    GE_DLLEXPIMPORT AcGeKnotVector(AcGeDoubleArray&& src, double eps = globalKnotTolerance);
    ...
    GE_DLLEXPIMPORT AcGeKnotVector&     operator =  (AcGeKnotVector&& src);
    GE_DLLEXPIMPORT AcGeKnotVector&     operator =  (const AcGeDoubleArray& src);
    GE_DLLEXPIMPORT AcGeKnotVector&     operator =  (AcGeDoubleArray&& src);
