...
//
inline AcGePoint2d AcGePoint2d::origin()
{
    return AcGePoint2d();
}

inline AcGePoint2d& AcGePoint2d::transformBy (const AcGeMatrix2d& leftSide)
{
...
inline AcGePoint2d& AcGePoint2d::setToSum(const AcGePoint2d& p, const AcGeVector2d& v)
{
    x = p.x + v.x;
    y = p.y + v.y;
    return *this;
...
// Global operator
inline AcGePoint2d operator *  (const AcGeMatrix2d& mat, const AcGePoint2d& pnt)
{
    return AcGePoint2d().setToProduct(mat, pnt);
}
