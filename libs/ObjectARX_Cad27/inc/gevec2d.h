...
public:
                    ...
                    AcGeVector2d(const AcGeVector2d& vec) = default;
    ...
    //
    static          AcGeVector2d   identity();
    static          AcGeVector2d   xAxis();
    static          AcGeVector2d   yAxis();
...
inline AcGeVector2d& AcGeVector2d::transformBy (const AcGeMatrix2d& leftSide)
{
...
//
inline AcGeVector2d AcGeVector2d::identity()
{
    return AcGeVector2d(0.0, 0.0);
}

inline AcGeVector2d AcGeVector2d::xAxis()
{
    return AcGeVector2d(1.0, 0.0);
}

inline AcGeVector2d AcGeVector2d::yAxis()
{
    return AcGeVector2d(0.0, 1.0);
}
...
inline AcGeVector2d AcGeVector2d::normal(const AcGeTol& tol) const
{
    return AcGeVector2d(*this).normalize(tol);
}
...
inline bool AcGeVector2d::isZeroLength(const AcGeTol& tol) const
{
...
// `s' and the vector `v'.
//
inline AcGeVector2d operator * (double s, const AcGeVector2d& v)
{
    return AcGeVector2d (s * v.x, s * v.y);
}

inline AcGeVector2d operator * (const AcGeMatrix2d& mat, const AcGeVector2d& vec)
{
    return AcGeVector2d().setToProduct(mat, vec);
}
