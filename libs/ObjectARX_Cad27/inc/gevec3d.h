...
public:
                    ...
                    AcGeVector3d(const AcGeVector3d& vec) = default;
    ...
    // Inline equivalents of the global constants.
    // May allow more compiler optimization
    //
             static AcGeVector3d   identity();
             static AcGeVector3d   xAxis();
             static AcGeVector3d   yAxis();
             static AcGeVector3d   zAxis();
    ...
    GE_DLLEXPIMPORT Adesk::Boolean isUnitLength(const AcGeTol& tol = AcGeContext::gTol) const;
                    bool           isZeroLength(const AcGeTol& tol = AcGeContext::gTol) const;
...
inline AcGeVector3d::AcGeVector3d(const AcGePlanarEnt& pIn, const AcGeVector2d& vec)
{
    this->set(pIn, vec);
}

// Same as default ctor, creates the identity translation vector
//
inline AcGeVector3d AcGeVector3d::identity()
{
    return AcGeVector3d();
}

inline AcGeVector3d AcGeVector3d::xAxis()
{
    return AcGeVector3d(1.0, 0.0, 0.0);
}

inline AcGeVector3d AcGeVector3d::yAxis()
{
    return AcGeVector3d(0.0, 1.0, 0.0);
}

inline AcGeVector3d AcGeVector3d::zAxis()
{
    return AcGeVector3d(0.0, 0.0, 1.0);
}

inline AcGeVector3d& AcGeVector3d::transformBy (const AcGeMatrix3d& leftSide)
{
...
// global operator
inline AcGeVector3d operator *  (const AcGeMatrix3d& mat, const AcGeVector3d& vec)
{
    return AcGeVector3d().setToProduct(mat, vec);
}
...
inline AcGeVector3d AcGeVector3d::normal(const AcGeTol& tol) const
{
    return AcGeVector3d(*this).normalize(tol);
}
...
inline bool AcGeVector3d::isZeroLength(const AcGeTol& tol) const
{
    return isEqualTo(identity(), tol);
}
...
// This global operator returns a vector that is the scalar product of
// `s' and the vector `v'.
//
