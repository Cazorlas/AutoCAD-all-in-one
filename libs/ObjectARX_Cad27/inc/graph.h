...
class AcDbGraph;
class AcDbGraphNode;
using AcDbGraphNodePtrArray = AcArray<AcDbGraphNode*>;
...
public:
    ...
    ACDBCORE2D_PORT Acad::ErrorStatus   markTree        (Adesk::UInt8 flags,
                                         AcDbGraphNodePtrArray* = NULL);
...
private:
    ...
    AcDbGraphNodePtrArray    mOutgoing;
    AcDbGraphNodePtrArray   mIncoming;

    void*               mpData = nullptr;

    void                setFirstLevel   (Adesk::Boolean);

    Adesk::UInt8        mFlags = 0;
    ...
    AcDbGraphNodePtrArray*   mpCycleOut = nullptr;
    AcDbGraphNodePtrArray*   mpCycleIn = nullptr;
};
...
public:
    ...
    ACDBCORE2D_PORT void                getOutgoing     (AcDbGraphNodePtrArray&);
...
private:
    ...
    AcDbGraphNodePtrArray    mNodes;

    // Cycle detection

    AcDbGraphNodePtrArray*   mpCycleNodes = nullptr;
