...
/// <summary>
/// Get the HBITMAP preview image for a standard hatch pattern.
/// </summary>
///
/// <param name="sPatternName">
/// The name of the standard hatch pattern to be used to generate the image.
/// </param>
/// <param name="patternColor">
/// The color of the hatch pattern.
/// If the color is set to none, the text color will be used.
/// </param>
/// <param name="backgroundColor">
/// The background color to be used for the bitmap image.
/// If the color set to none, the Window color will be used.
/// </param>
/// <param name="nWidth">
/// The nonzero width of the bitmap in pixels.
/// </param>
/// <param name="nHeight">
/// The nonzero height of the bitmap in pixels.
/// </param>
///
/// <returns>
/// HBITMAP if successful, otherwise a nullptr.
/// Caller is responsible for calling DeleteObject
/// </returns>
HBITMAP acedGetHatchPatternSwatchImage(const AcString& cstrName,
    const AcCmColor& patternColor, const AcCmColor& backgroundColor,
    int nWidth, int nHeight);

/// <summary>
/// Get the HBITMAP preview image for a custom defined hatch pattern.
/// </summary>
///
/// <param name="sPatternName">
/// The name of the custom hatch pattern to be used to generate the image.
/// Note, do not include the path or ".pat" in the custom hatch pattern name.
/// </param>
/// <param name="patternColor">
/// The color of the hatch pattern.
/// If the color is set to none, the text color will be used.
...
/// Caller is responsible for calling DeleteObject
/// </returns>
HBITMAP acedGetCustomHatchPatternSwatchImage(const AcString& cstrName,
    const AcCmColor& patternColor, const AcCmColor& backgroundColor,
    int nWidth, int nHeight);

/// <summary>
/// Get the HBITMAP preview image for a gradient hatch pattern.
/// </summary>
///
/// <param name="sPatternName">
/// The name of the gradient hatch pattern to be used to generate the image.
/// </param>
/// <param name="dAngle">
/// The rotation angle of the gradient hatch pattern
/// </param>
/// <param name="bShifted">
/// Specifies whether the orientation of the gradient pattern is shifted 
/// up and to the left (true) to the center (false).
/// </param>
/// <param name="startColor">
/// The first color of the gradient hatch pattern
/// </param>
/// /// <param name="stopColor">
/// The second color of the gradient hatch pattern
/// </param>
/// <param name="nWidth">
/// The nonzero width of the bitmap in pixels.
/// </param>
...
/// Caller is responsible for calling DeleteObject
/// </returns>
HBITMAP acedGetGradientPatternSwatchImage(const AcString& sPatternName,
    double dAngle, bool bShifted,
    const AcCmColor& startColor, const AcCmColor& stopColor,
    int nWidth, int nHeight);
