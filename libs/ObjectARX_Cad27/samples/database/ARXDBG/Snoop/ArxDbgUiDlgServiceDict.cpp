...
ArxDbgUiDlgServiceDict::buildColumns()
{
    ...
    //
    lvc.pszText = const_cast<wchar_t*>(L"Name");
    m_lcServices.InsertColumn(0, &lvc);

    lvc.cx = col2_width;
    lvc.pszText = const_cast<wchar_t*>(L"Class");
    m_lcServices.InsertColumn(1, &lvc);

    lvc.cx = col3_width;
    lvc.pszText = const_cast<wchar_t*>(L"ID");
    m_lcServices.InsertColumn(2, &lvc);

    lvc.cx = col4_width;
    lvc.pszText = const_cast<wchar_t*>(L"Unloadable");
