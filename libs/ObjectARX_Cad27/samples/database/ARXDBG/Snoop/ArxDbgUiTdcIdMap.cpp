...
ArxDbgUiTdcIdMap::buildMapItemColumns()
{
    ...
    //
    lvc.pszText = const_cast<wchar_t*>(L"Object");
    lvc.iSubItem = 0;
    m_lcObjList.InsertColumn(0, &lvc);

    lvc.cx = col2_width;
    lvc.iSubItem = 1;
    lvc.pszText = const_cast<wchar_t*>(L"Handle");
	...
	lvc.cx = col5_width;
    lvc.iSubItem = 4;
    lvc.pszText = const_cast<wchar_t*>(L"Cloned");
    m_lcObjList.InsertColumn(4, &lvc);

	lvc.cx = col6_width;
    lvc.iSubItem = 5;
    lvc.pszText = const_cast<wchar_t*>(L"Primary");
    m_lcObjList.InsertColumn(5, &lvc);

	lvc.cx = col7_width;
    lvc.iSubItem = 6;
    lvc.pszText = const_cast<wchar_t*>(L"Owner Xlated");
