...
public:
    CDocInfo()
    {this->undoBtnAvailable=false; this->undoCmd=false;}
...
public:
    ...
    CDocInfo& docData(AcApDocument* pDoc)
    {
        std::map<AcApDocument*, CDocInfo>::iterator i;
...
private:
    std::map<AcApDocument*, CDocInfo> m_dataMap;
};
