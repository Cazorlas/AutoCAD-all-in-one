...
public:
    ...
    //
    bool              isTrimInputEdge (int index, AcString& expressionOut) const;
    ...
    //
    double            getRadius(AcString& expressionOut) const;
    Acad::ErrorStatus setRadius(double rad, const AcString& expression);
