...
//
Acad::ErrorStatus
getYOrN(const wchar_t* promptStr, Adesk::Boolean defaultY, Adesk::Boolean& yes,Adesk::Boolean& interrupted);
...
HRESULT CPolyCommand::appendToSpace()
{
    ...
    wchar_t tmpStr[] = { L'A', L's', L'd', L'k', L'P', L'o', L'l', L'y', L'\0'};
    m_pBaseObj->AddToDb(obj,m_pDb->currentSpaceId(), tmpStr);
