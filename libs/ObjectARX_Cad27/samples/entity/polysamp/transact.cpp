...
static Acad::ErrorStatus getASolid(const wchar_t* prompt, 
...
// External functions from command.cpp
//
Acad::ErrorStatus getYOrN(const wchar_t*, Adesk::Boolean, Adesk::Boolean&,Adesk::Boolean& interrupted);
...
static Acad::ErrorStatus
getASolid(const wchar_t* prompt, 
          AcTransaction* pTransaction, 
          AcDb::OpenMode mode,
          AcDbObjectId   checkWithThisId,
          AcDb3dSolid*&  pSolid)
