...
#define MASSERT(x) AMODELER_NAMESPACE::assertFunction(x, ACRX_T(__FILE__), __LINE__, ACRX_T(#x))
#define FAIL       AMODELER_NAMESPACE::assertFunction(0, ACRX_T(__FILE__), __LINE__, ACRX_T("FAIL"))
