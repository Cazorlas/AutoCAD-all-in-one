...
static AcGePoint3d getPoint(const wchar_t* prompt = L'\0');
static double getDistance(AcGePoint3d fromPt, const wchar_t* prompt = L'\0', double defaultDist = 0.0);
static int getInt(const wchar_t* prompt = L'\0', int defaultValue = 0);
static double getReal(const wchar_t* prompt = L'\0', double defaultValue = 0.0);
...
static double
getDistance(AcGePoint3d fromPt, const wchar_t* prompt, double defaultDist)
{
    int adsrc;
    ads_point p;
...
static int
getInt(const wchar_t* prompt, int defaultValue)
{
    int i;
...
static double
getReal(const wchar_t* prompt, double defaultValue)
{
    double dbl;
