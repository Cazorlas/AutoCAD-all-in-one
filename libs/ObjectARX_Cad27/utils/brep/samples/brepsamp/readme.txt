...
with the behaviour of various functions within acbr26.dll, and
to exemplify proper usage of the functions in an integrated
environment.  Please note that if you wish to use acbr26.dll in
your own application you must load it by using acrxDynamicLinker
as in the sample app because acbr26.dll is an ARX application
